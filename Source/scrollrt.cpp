...
static void DrawObject(int x, int y, int ox, int oy, BOOL pre)
{
	...
	if (bv == pcursobj)
		...
		if (rogueDetectedTrap(object[bv]._oTrapFlag) == true) {
			int offset = 2;
...
void DrawWeaponSwitchIcons() {
	...
	CelDraw(RIGHT_PANEL_X + 17*1.8, 233, weaponSwitchIcons, panbtn[7] + 3+(plr[myplr].currentWeaponSet==0), 33);
	CelDraw(RIGHT_PANEL_X + 17*1.8, 233, weaponSwitchIcons, panbtn[7] + 5+(plr[myplr].currentWeaponSet != 0), 33);
	int offset = 231;
	CelDraw(RIGHT_PANEL_X + 17*1.8+offset, 233, weaponSwitchIcons, panbtn[7] + 3+(plr[myplr].currentWeaponSet == 0), 33);
	CelDraw(RIGHT_PANEL_X + 17*1.8+offset, 233, weaponSwitchIcons, panbtn[7] + 5+(plr[myplr].currentWeaponSet != 0), 33);
}
