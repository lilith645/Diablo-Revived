...
void PrintMonstHistory(int mt)
{
	...
	sprintf(tempstr, "Type: %s  Kills: %i", get_monster_type_text(monsterdata[mt]), monstkills[mt]);
...
void PrintUniqueHistory()
{
	...
	sprintf(tempstr, "Type: %s", get_monster_type_text(*monster[pcursmonst].MData));
	AddPanelString(tempstr, TRUE);
