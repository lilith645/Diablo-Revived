...
#define XPBAR_WIDTH BUFFER_WIDTH * 0.24
#define XPBAR_HEIGHT 4
#define XPBAR_THICKNESS 4
#define XPBAR_SEGMENTS 10
#define XPBAR_SEGMENT_SIZE 1/XPBAR_SEGMENTS
#define XPBAR_BORDER 1
#define XPBAR_Y SCREEN_HEIGHT+SCREEN_Y-XPBAR_THICKNESS*2.0-1
#define XPBAR_LEFT BUFFER_WIDTH*0.5-XPBAR_WIDTH*0.5
#define XPBAR_RIGHT BUFFER_WIDTH*0.5-XPBAR_WIDTH*0.5
#define XPBAR_TOP XPBAR_Y+XPBAR_THICKNESS+XPBAR_BORDER*2.0-XPBAR_BORDER
#define XPBAR_BOTTOM XPBAR_Y-XPBAR_BORDER
